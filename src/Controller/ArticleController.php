...
///////////////////////front-office////////////////////////////
    /**
     * @Route("/article", name="article_client_index", methods={"GET"})
     */
    public function articleClint(ArticleRepository $articleRepository): Response
    {
    ...
    /**
     * @Route("/article/{id}/", name="article_client_show", methods={"GET"})
     */
