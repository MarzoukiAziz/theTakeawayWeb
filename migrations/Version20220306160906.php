 ...
 */
final class Version20220306160906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restaurant_favoris (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT DEFAULT NULL, client_id INT DEFAULT NULL, INDEX IDX_43789847B1E7706E (restaurant_id), INDEX IDX_4378984719EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
