 ...
 */
final class Version20220216154733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, client_id_id INT NOT NULL, admin_charge_id INT DEFAULT NULL, restaurant_id INT NOT NULL, date DATE NOT NULL, heure_arrive TIME NOT NULL, heure_depart TIME NOT NULL, nb_personne INT NOT NULL, statut VARCHAR(20) NOT NULL, INDEX IDX_42C84955DC2902E0 (client_id_id), INDEX IDX_42C84955BCDF4C26 (admin_charge_id), INDEX IDX_42C84955B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
