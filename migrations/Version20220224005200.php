 ...
 */
final class Version20220224005200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE menu_element CHANGE prix prixx DOUBLE PRECISION NOT NULL');
    }
