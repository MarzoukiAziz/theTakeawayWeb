 ...
 */
final class Version20220217160001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingrediant CHANGE restaurant_id_id restaurant_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE promotion CHANGE date_debut db DATE NOT NULL');
        $this->addSql('ALTER TABLE restaurant CHANGE architecture architecture VARCHAR(255) NOT NULL, CHANGE images images LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE nom prenom VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE ingrediant CHANGE restaurant_id_id restaurant_id_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE promotion CHANGE banner banner VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE db date_debut DATE NOT NULL');
        ...
        $this->addSql('ALTER TABLE restaurant ADD nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP prenom, CHANGE adresse adresse VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE architecture architecture VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE telephone telephone VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE images images LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
    }
}
