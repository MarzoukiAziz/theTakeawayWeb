 ...
 */
final class Version20220217160044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carte_bancaire CHANGE nom prenom VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carte_bancaire ADD nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP prenom, CHANGE numero numero VARCHAR(16) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE cvv cvv VARCHAR(3) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
