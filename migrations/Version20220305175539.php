 ...
 */
final class Version20220305175539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image CHANGE user_id client_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image CHANGE client_id user_id INT DEFAULT NULL');
